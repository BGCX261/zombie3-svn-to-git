...
#endif
#define DECIMAL_TOKEN 258
#define EQUAL_TOKEN 259
#define ID_TOKEN 260
#define STRING_TOKEN 261




/* Copy the first part of user declarations.  */
#line 4 "myfile/src/config_parser.y"
...
#line 25 "myfile/src/config_parser.y"
typedef union YYSTYPE {
  char *astring;  /* /!\ Each token must be freed after usage.*/
} YYSTYPE;
/* Line 191 of yacc.c.  */
#line 121 "config_parser.tab.c"
...
{
  "$end", "error", "$undefined", "DECIMAL_TOKEN", "EQUAL_TOKEN", "ID_TOKEN", 
  "STRING_TOKEN", "'\\n'", "$accept", "config_list", "config", 0
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 4:
#line 38 "myfile/src/config_parser.y"
    {
		 config_err++;
	       ;}
    break;
  ...
  case 5:
#line 44 "myfile/src/config_parser.y"
    {
	      config_file->SetValue(yyvsp[-3].astring,yyvsp[-1].astring);
	      free(yyvsp[-3].astring); free(yyvsp[-1].astring);
	    ;}
    break;

  case 6:
#line 49 "myfile/src/config_parser.y"
    {
	      config_file->SetValue(yyvsp[-3].astring,yyvsp[-1].astring);
	      free(yyvsp[-3].astring); free(yyvsp[-1].astring);
	    ;}
...
#line 56 "myfile/src/config_parser.y"
