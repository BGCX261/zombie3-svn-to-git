...
int CMixerControl::GetControlInfo( MIXERLINE* pMixerLine, HMIXER hMixer )
{
	...
	memset( (void*)mpMixerControlStateInfo, 0, mnControlCount*sizeof(MIXERCONTROLDETAILS) ) ;
...
int CMixerControl::InitMixerControlDetails() 
{
	...
	for( n1=0 ; n1<mnControlCount ; n1++ )
	{
		...
		default:
			mpMixerControlStateInfo[n1].cbDetails = 0 ;
					...
					unsigned int* nSizeOfDetails )	
{
	...
	for( n1=0 ; n1<mnControlCount && mpMixerControl ; n1++ )
	{
